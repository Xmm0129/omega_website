          ...
          <div className="w-full space-y-12">
            ...
            <div className="mt-16">
              <div className="text-center mb-8">
                <h3 className="text-3xl text-cyan-300 mb-4 font-bold drop-shadow-lg">我的相册 📸</h3>
                <p className="text-white/80 text-lg">记录我的美好时光，分享我的可爱瞬间</p>
              </div>
              ...
              {/* 图片画廊 - 调整高度 */}
              {!loading && !error && (
                <div className="h-[450px] rounded-xl overflow-hidden bg-white/5 backdrop-blur-sm border border-white/10">
                  <CircularGallery
                    items={galleryItems}
                    bend={2}
                    textColor="#06b6d4"
